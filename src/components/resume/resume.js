          ...
          <div className="container">
            <div className="cont-wrap-bck">
              ...
              <div className="wrap-details">
                ...
                <p>
                  <b>Name : </b>Umairatul Asyiqin Begum
                </p>
                <p>
                  <b>Major : </b>BSc(Hons) e-Business Technology & Management @
                  Liverpool John Moores University, UK 3+0
                </p>
                <p>
                  <b>Award Accredited : </b>Bachelor in Science with Honors
                  Class I (73%)
                </p>
                <p>
                  <b>Language Spoken : </b>English / Malay
                </p>
                <p>
                  <b>Address : </b>Kuala Lumpur, Malaysia
                </p>
                <p>
                  <b>Email : </b>umairatlwork@gmail.com
                </p>
                <br />
              </div>
        ...
        <div className="mobile-view-resume">
          <section>
            ...
            <div className="cont-resume-mobile">
              ...
              <p>
                <b>Award Accredited : </b>Bachelor in Science with Honors Class
                I (73%)
              </p>
              <p>
                <b>Language Spoken : </b>English / Malay

...
const SkillsMobile = () => {
    ...
    <div className='skills-mobile'>
        <div class='top-cont-skills'>
        <h1>Skills</h1>
        <p>Below are the frameworks and programming languages that i have worked with</p>
        </div>
        <div className='wrap-card'>
    <Card className='card-skills'>
      {/* <CardMedia  */}
      <img className='img-html' src={html} width='270px' height='160px' style={{marginLeft : '0px'}}/>
        {/* // component="img"  */}
        {/* height="180" */}
        {/* // <i */}
        {/* // image={html} */}
      ...
      <CardContent className='title-skills-mob'>
        ...
        Able to create responsive and dynamic web app suing html, css and js
        </Typography>
      </CardContent>
    </Card>
    ...
    <img src={typescript} width='160px' height='160px'/>
      ...
      <CardContent className='title-skills-mob'>
        ...
        <Typography  style={{color: 'white'}}>
          Understood briefly the concept of object based and have used it with typescript before
        </Typography>
      </CardContent>
    </Card>
    </div>
